...
def train_ctde():
    ...
    log_dir = '/home/ytj/PycharmProjects/MARL_TSC/logs/h_bus/850/ctde/no_md'
    ...
    config = (
        ...
        .training(
            ...
            # use_kl_loss=False,
            kl_coeff=0.0,
            # kl_coeff=tune.grid_search([0.0]),
            vf_share_layers=False,
            gamma=0.9,
            # gamma=tune.grid_search([0.62, 0.64, 0.66, 0.68]),
...
if __name__ == "__main__":
    # train_ctde()
    policy_path = 'logs/h_bus/850/ctde/no_md/PPO_2024-02-10_20-17-45/PPO_sumo_env_5de37_00001_1_2024-02-10_20-17-47/checkpoint_001855'
    # test_ctde(policy_path)
    evaluate_ctde(policy_path)
    # evaluation('logs/h_bus/400/ctde/md_far/PPO_2024-04-15_23-40-50')
