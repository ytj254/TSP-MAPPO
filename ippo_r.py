...
def train():
    ...
    log_dir = '/home/ytj/PycharmProjects/MARL_TSC/logs/r_bus/offpeak/ippo'
...
def test(policy_path, gui=True, log=True):
    ...
    sumo_cmd = set_sumo(
        gui=gui,
        sumocfg_path='scenarios/r_corridor/r.sumocfg',
...
if __name__ == "__main__":
    ...
    evaluation('logs/r_bus/offpeak/ippo/PPO_2024-05-21_22-18-38')
