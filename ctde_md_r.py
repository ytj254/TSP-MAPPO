...
def train_ctde():
    ...
    config = (
        ...
        .multi_agent(
            # policies={
            #     'policy1': PolicySpec(
            #         config=PPOConfig.overrides(gamma=0.85)
            #     ),
            #     'policy2': PolicySpec(
            #         config=PPOConfig.overrides(gamma=0.65)
            #     ),
            # }
...
if __name__ == "__main__":
    # train_ctde()
    policy_path = 'logs/r_bus/peak/ctde/md_far/PPO_2024-02-18_18-08-28/PPO_sumo_env_a1605_00000_0_gamma=0.8500,lambda=0.9900_2024-02-18_18-08-30/checkpoint_000092'
    test_ctde(policy_path)
    # evaluate_ctde(policy_path)
    # evaluation('logs/r_bus/peak/ctde/md_far/PPO_2024-04-03_09-08-23')
